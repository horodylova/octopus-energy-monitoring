...
const BooleanCell = (props: GridCustomCellProps) => {
  return (
...
const StatusCustomGridCell = (props: GridCustomCellProps) => {
...
const NameCustomGridCell = (props: GridCustomCellProps) => {
...
const CreatedCustomGridCell = (props: GridCustomCellProps) => {
  return props.isInEdit ? (
    <td {...props.tdProps}>
...
const LastUsedCustomGridCell = (props: GridCustomCellProps) => {
  return props.isInEdit ? (
    <td {...props.tdProps}>
